...
<html>
	<head>
		<meta charset="UTF-8">
		<title>로그인</title>
		<link rel="stylesheet" href="/mins/css/style.css" />
	</head>
	<body>
		<div id="member">
			<section class="login">		
				<form action="/mins/member/login" method="post">
					<table>
						<tr>
							<td><img src="/sboard/img/login_ico_id.png" alt="아이디" /></td>
							<td><input type="text" name="userid" required placeholder="아이디 입력" autocomplete="off" /></td>
						</tr>
						<tr>
